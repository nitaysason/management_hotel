...
from .views import register, login_view, logout_view, RoomView, make_reservation, view_reservations, cancel_reservation, order_treatment, view_orders, book_ticket, view_tickets, contact_hotel
